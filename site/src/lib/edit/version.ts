...
// vitest, matching the pattern in ../audience.ts). Each publication writes the same commit
// to version.json; polling that file lets a running tab notice its bundle is stale.
