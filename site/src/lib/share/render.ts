...
function css(context: ShareContext): string {
  ...
  * { box-sizing: border-box; }
  ...
  .share-card-content-over-cover { width:100%;padding:13px;border:1px solid color-mix(in srgb,var(--color-border-subtle-default) 72%,transparent);border-radius:13px;background:linear-gradient(135deg,color-mix(in srgb,var(--roadmap-product-accent) 7%,transparent),transparent 62%),color-mix(in srgb,var(--color-card) 76%,transparent);box-shadow:0 12px 30px rgb(10 14 20 / 20%),inset 0 1px 0 rgb(255 255 255 / 28%);-webkit-backdrop-filter:blur(14px) saturate(.78);backdrop-filter:blur(14px) saturate(.78); }
  ...
  [data-theme="dark"] .share-card-content-over-cover { border-color:rgb(255 255 255 / 14%);background:linear-gradient(135deg,color-mix(in srgb,var(--roadmap-product-accent) 9%,transparent),transparent 62%),color-mix(in srgb,var(--color-card) 74%,transparent);box-shadow:0 14px 34px rgb(0 0 0 / 36%),inset 0 1px 0 rgb(255 255 255 / 10%); }
  ...
  .detail-masthead.has-cover .detail-masthead-copy { width:fit-content;max-width:min(100%,960px);padding:14px 16px;border:1px solid color-mix(in srgb,var(--color-border-subtle-default) 72%,transparent);border-radius:13px;background:linear-gradient(135deg,color-mix(in srgb,var(--roadmap-product-accent) 7%,transparent),transparent 62%),color-mix(in srgb,var(--color-card) 78%,transparent);box-shadow:0 12px 32px rgb(10 14 20 / 20%),inset 0 1px 0 rgb(255 255 255 / 28%);-webkit-backdrop-filter:blur(14px) saturate(.78);backdrop-filter:blur(14px) saturate(.78); }
  [data-theme="dark"] .detail-masthead.has-cover .detail-masthead-copy { border-color:rgb(255 255 255 / 14%);background:linear-gradient(135deg,color-mix(in srgb,var(--roadmap-product-accent) 9%,transparent),transparent 62%),color-mix(in srgb,var(--color-card) 76%,transparent);box-shadow:0 14px 36px rgb(0 0 0 / 36%),inset 0 1px 0 rgb(255 255 255 / 10%); }
  @supports not ((-webkit-backdrop-filter:blur(1px)) or (backdrop-filter:blur(1px))) { .detail-masthead.has-cover .detail-masthead-copy { background:color-mix(in srgb,var(--color-card) 96%,transparent); } }
