...
:global(:root[data-theme='dark']) .detail-masthead.has-cover .detail-masthead-copy { border-color:rgb(255 255 255 / 14%); background:linear-gradient(135deg,color-mix(in srgb,var(--roadmap-product-accent) 9%,transparent),transparent 62%),color-mix(in srgb,var(--color-card) 76%,transparent); box-shadow:0 14px 36px rgb(0 0 0 / 36%),inset 0 1px 0 rgb(255 255 255 / 10%); }
